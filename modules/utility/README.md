...
If you have enabled color globally in *zzshrc*, you may disable it for certain
commands.

To disable `ls` color, add the following line to *zzshrc*; when coloring is
disabled, type indicators (\*, /, =>, @, =, |, %) will be appended to entries.

    zstyle ':zsh:module:utility:ls' color 'no'

To disable `diff` highlighting, add the following line to *zzshrc*:

    zstyle ':zsh:module:utility:diff' color 'no'

To disable `wdiff` highlighting, add the following line to *zzshrc*:

    zstyle ':zsh:module:utility:wdiff' color 'no'

To disable `make` highlighting, add the following line to *zzshrc*:

    zstyle ':zsh:module:utility:make' color 'no'
